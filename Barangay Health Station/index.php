...
if (!function_exists('staff_icon')) {
    function staff_icon(string $name): string
    {
        $icons = [
            ...
            'logo' => '<svg width="16" height="16" viewBox="0 0 24 24" style="width:16px;height:16px;max-width:16px;max-height:16px;display:inline-block;vertical-align:middle;"><path d="M6 3v6a4 4 0 0 0 8 0V3m-6 0h4m6 8a3 3 0 1 0 3 3v-4m-3 7a4 4 0 0 1-4 4h-1a4 4 0 0 1-4-4v-1" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>',
            'dashboard' => '<svg width="16" height="16" viewBox="0 0 24 24" style="width:16px;height:16px;max-width:16px;max-height:16px;display:inline-block;vertical-align:middle;"><path d="M4 4h6v6H4V4Zm10 0h6v6h-6V4ZM4 14h6v6H4v-6Zm10 3h6m-6 3h6v-6h-6v6Z" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>',
            ...
            'queue' => '<svg width="16" height="16" viewBox="0 0 24 24" style="width:16px;height:16px;max-width:16px;max-height:16px;display:inline-block;vertical-align:middle;"><path d="M4 7h16M4 12h10M4 17h7" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>',
            'events' => '<svg width="16" height="16" viewBox="0 0 24 24" style="width:16px;height:16px;max-width:16px;max-height:16px;display:inline-block;vertical-align:middle;"><path d="M8 2v4m8-4v4M3 10h18M5 5h14a2 2 0 0 1 2 2v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2Z" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M12 14v4m-2-2h4" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>',
            'patients' => '<svg width="16" height="16" viewBox="0 0 24 24" style="width:16px;height:16px;max-width:16px;max-height:16px;display:inline-block;vertical-align:middle;"><path d="M16 21v-2a4 4 0 0 0-4-4H7a4 4 0 0 0-4 4v2m18 0v-2a4 4 0 0 0-3-3.87M14 7a4 4 0 1 1-8 0 4 4 0 0 1 8 0Zm7 14v-2a4 4 0 0 0-3-3.87M18 3a4 4 0 0 1 0 8" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>',
            'plus' => '<svg width="16" height="16" viewBox="0 0 24 24" style="width:16px;height:16px;max-width:16px;max-height:16px;display:inline-block;vertical-align:middle;"><path d="M12 5v14M5 12h14" fill="none" stroke="currentColor" stroke-width="2.25" stroke-linecap="round" stroke-linejoin="round"/></svg>',
            ...
            'check' => '<svg width="16" height="16" viewBox="0 0 24 24" style="width:16px;height:16px;max-width:16px;max-height:16px;display:inline-block;vertical-align:middle;"><path d="m5 12 5 5L20 7" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>',
            'camera' => '<svg width="16" height="16" viewBox="0 0 24 24" style="width:16px;height:16px;max-width:16px;max-height:16px;display:inline-block;vertical-align:middle;"><path d="M4 7h4l2-2h4l2 2h4v12H4V7Zm8 9a4 4 0 1 0 0-8 4 4 0 0 0 0 8Z" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>',
            'x' => '<svg width="16" height="16" viewBox="0 0 24 24" style="width:16px;height:16px;max-width:16px;max-height:16px;display:inline-block;vertical-align:middle;"><path d="m6 6 12 12M18 6 6 18" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>',
            'filter' => '<svg width="16" height="16" viewBox="0 0 24 24" style="width:16px;height:16px;max-width:16px;max-height:16px;display:inline-block;vertical-align:middle;"><path d="M3 5h18l-7 8v6l-4-2v-4L3 5Z" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>',
            'pin' => '<svg width="16" height="16" viewBox="0 0 24 24" style="width:16px;height:16px;max-width:16px;max-height:16px;display:inline-block;vertical-align:middle;"><path d="M12 21s-6-5.33-6-11a6 6 0 1 1 12 0c0 5.67-6 11-6 11Zm0-8.5a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5Z" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>',
            'clock' => '<svg width="16" height="16" viewBox="0 0 24 24" style="width:16px;height:16px;max-width:16px;max-height:16px;display:inline-block;vertical-align:middle;"><path d="M12 8v5l3 2m6-3a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>',
            ...
            'eye' => '<svg width="16" height="16" viewBox="0 0 24 24" style="width:16px;height:16px;max-width:16px;max-height:16px;display:inline-block;vertical-align:middle;"><path d="M2 12s3.5-7 10-7 10 7 10 7-3.5 7-10 7S2 12 2 12Zm10 3a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>',
            'history' => '<svg width="16" height="16" viewBox="0 0 24 24" style="width:16px;height:16px;max-width:16px;max-height:16px;display:inline-block;vertical-align:middle;"><path d="M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8m0-5v5h5M12 7v5l4 2" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>',
            'search' => '<svg width="16" height="16" viewBox="0 0 24 24" style="width:16px;height:16px;max-width:16px;max-height:16px;display:inline-block;vertical-align:middle;"><path d="m21 21-4.35-4.35M10.5 18a7.5 7.5 0 1 1 0-15 7.5 7.5 0 0 1 0 15Z" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>',
            ...
            'shield' => '<svg width="16" height="16" viewBox="0 0 24 24" style="width:16px;height:16px;max-width:16px;max-height:16px;display:inline-block;vertical-align:middle;"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>',
            'heart' => '<svg width="16" height="16" viewBox="0 0 24 24" style="width:16px;height:16px;max-width:16px;max-height:16px;display:inline-block;vertical-align:middle;"><path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>',
            'syringe' => '<svg width="16" height="16" viewBox="0 0 24 24" style="width:16px;height:16px;max-width:16px;max-height:16px;display:inline-block;vertical-align:middle;"><path d="m14 4 6 6M5 19l7.5-7.5M9.5 8.5 17 16M4 20l3-3M3 21l3-3" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="m8 16 9-9 3 3-9 9-3-3Z" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>',
            'baby' => '<svg width="16" height="16" viewBox="0 0 24 24" style="width:16px;height:16px;max-width:16px;max-height:16px;display:inline-block;vertical-align:middle;"><path d="M9 12h.01M15 12h.01M10 16c.5.5 1.2.8 2 .8s1.5-.3 2-.8" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><circle cx="12" cy="12" r="8" fill="none" stroke="currentColor" stroke-width="2"/><path d="M12 4v-2M9 4.5C9.5 3 10.5 2 12 2c1.5 0 2.5 1 3 2.5" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>',
            'pulse' => '<svg width="16" height="16" viewBox="0 0 24 24" style="width:16px;height:16px;max-width:16px;max-height:16px;display:inline-block;vertical-align:middle;"><path d="M22 12h-4l-3 9L9 3l-3 9H2" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>',
            'stethoscope' => '<svg width="16" height="16" viewBox="0 0 24 24" style="width:16px;height:16px;max-width:16px;max-height:16px;display:inline-block;vertical-align:middle;"><path d="M4.5 3v5a4.5 4.5 0 0 0 9 0V3M9 12.5a4.5 4.5 0 0 0 4.5 4.5H15a3 3 0 0 0 3-3v-2" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><circle cx="18" cy="10" r="2.5" fill="none" stroke="currentColor" stroke-width="2"/></svg>',
            ...
            'phone' => '<svg width="16" height="16" viewBox="0 0 24 24" style="width:16px;height:16px;max-width:16px;max-height:16px;display:inline-block;vertical-align:middle;"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 5.15 11.8 19.79 19.79 0 0 1 2.08 3.12 2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>',
            'alert' => '<svg width="16" height="16" viewBox="0 0 24 24" style="width:16px;height:16px;max-width:16px;max-height:16px;display:inline-block;vertical-align:middle;"><path d="M12 9v4m0 4h.01M10.29 3.86 1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>',
...
if ($page === 'unattended') {
    $redir = ['page' => 'dashboard', 'view' => 'unattended'];
    if (isset($_GET['timeframe'])) $redir['timeframe'] = $_GET['timeframe'];
    if (isset($_GET['type'])) $redir['type'] = $_GET['type'];
    if (isset($_GET['unattended_search'])) $redir['unattended_search'] = $_GET['unattended_search'];
    header('Location: ?' . http_build_query($redir));
    exit;
}
$isUnattendedDashboardView = ($page === 'dashboard' && $view === 'unattended');
...
if ($patientSearch !== '') {
    ...
    $patientDateFilteredAppointments = array_values(array_filter(
        ...
        static function(array $item) use ($st): bool {
            ...
            $pid = strtolower((string) ($item['patient_id'] ?? ''));
            $addr = strtolower((string) ($item['complete_address'] ?? ''));
            return str_contains($name, $st) || str_contains($code, $st) || str_contains($phone, $st) || str_contains($svc, $st) || str_contains($pid, $st) || str_contains($addr, $st);
        }
    ));
}
...
<div class="staff-shell">
    ...
    <main class="staff-main">
        ...
        <?php if ($page === 'dashboard'): ?>
            <?php if ($isUnattendedDashboardView): ?>
                <?php
                ...
                ?>
                <div class="unattended-subpage-container">
                    <!-- Top Navigation Bar & Breadcrumb -->
                    <div class="unattended-subpage-topbar">
                        <a href="?page=dashboard" class="unattended-back-to-dash-btn">
                            <svg viewBox="0 0 24 24" width="18" height="18" stroke="currentColor" stroke-width="2.4" fill="none" stroke-linecap="round" stroke-linejoin="round"><line x1="19" y1="12" x2="5" y2="12"/><polyline points="12 19 5 12 12 5"/></svg>
                            <span>Back to Dashboard</span>
                        </a>
                        <div class="unattended-subpage-breadcrumbs">
                            <a href="?page=dashboard">Dashboard</a>
                            <span class="sep">/</span>
                            <span class="current">Station Operations Audit</span>
                        </div>
                    </div>

                    <!-- Hero Header -->
                    <section class="unattended-page-hero">
                        <div class="unattended-hero-meta">
                            <div class="unattended-hero-badge">
                                <?= staff_icon('clock'); ?>
                                <span>Operations &amp; Compliance Audit • <?= h($station['name']); ?></span>
                            </div>
                            <h1>Unattended &amp; Unserved Records</h1>
                            <p>Detailed operational ledger of consultation requests past scheduled dates and incomplete station queues requiring staff review or patient contact.</p>
                        </div>
                        <div class="unattended-hero-counter">
                            <span class="num"><?= $currentTfCount['total']; ?></span>
                            <span class="lbl"><?= h($currentTimeframeLabel); ?> Items</span>
                        </div>
                    </section>

                    <!-- Filter & Control Toolbar Card -->
                    <section class="unattended-controls-card">
                        <div class="unattended-controls-left">
                            <div class="unattended-timeframe-picker">
                                <label for="unattendedTimeframeSelect" class="unattended-control-label">
                                    <?= staff_icon('calendar'); ?>
                                    <span>Timeframe:</span>
                                </label>
                                <form method="get" class="unattended-timeframe-form" style="margin:0;">
                                    <input type="hidden" name="page" value="dashboard">
                                    <input type="hidden" name="view" value="unattended">
                            ...
                            <div class="unattended-type-pills">
                                <a href="?page=dashboard&view=unattended&timeframe=<?= h($unattendedTimeframe); ?><?= $unattendedSearch !== '' ? '&unattended_search=' . urlencode($unattendedSearch) : ''; ?>&type=all" 
                                   class="unattended-type-pill <?= $unattendedType === 'all' ? 'active' : ''; ?>">
                                    <span>All Records</span>
                                    <span class="count"><?= $currentTfCount['total']; ?></span>
                                </a>
                                <a href="?page=dashboard&view=unattended&timeframe=<?= h($unattendedTimeframe); ?><?= $unattendedSearch !== '' ? '&unattended_search=' . urlencode($unattendedSearch) : ''; ?>&type=appts" 
                                ...
                                <a href="?page=dashboard&view=unattended&timeframe=<?= h($unattendedTimeframe); ?><?= $unattendedSearch !== '' ? '&unattended_search=' . urlencode($unattendedSearch) : ''; ?>&type=queue" 
                        ...
                        <!-- Search Input Form -->
                        <div class="unattended-controls-right">
                            <form method="get" class="unattended-search-wrap">
                                <input type="hidden" name="page" value="dashboard">
                                <input type="hidden" name="view" value="unattended">
                    ...
                    <!-- 3 KPI Metric Cards for Timeframe -->
                    <section class="unattended-kpis-grid">
                        <article class="unattended-kpi-card amber">
                            ...
                            <div class="unattended-kpi-content">
                                ...
                                <small class="unattended-kpi-hint">Booked visits past date without action</small>
                            </div>
                        </article>
                        ...
                        <article class="unattended-kpi-card orange">
                            ...
                            <div class="unattended-kpi-content">
                                ...
                                <small class="unattended-kpi-hint">Queued visits unfinalized at day end</small>
                            </div>
                        </article>
                    ...
                    <?php if (!$hasAnyRecords): ?>
                        <div class="unattended-empty-card">
                    ...
                    <?php else: ?>
                        ...
                        <?php if ($showAppts && $pageUnattendedAppts !== []): ?>
                            <section class="unattended-records-section">
                                <div class="unattended-section-header">
                                    <div class="unattended-section-title-wrap">
                                        ...
                                        <div>
                                            ...
                                            <p>Booked patient appointments that passed scheduled dates without staff confirmation or cancellation</p>
                                        </div>
                                    </div>
                                    <span class="unattended-type-tag amber"><?= count($pageUnattendedAppts); ?> Missed Actions</span>
                                </div>
                                ...
                                <div class="unattended-cards-stack">
                                    <?php foreach ($pageUnattendedAppts as $appt): ?>
                                        ...
                                        ?>
                                        <article class="unattended-record-card is-appts">
                                            <div class="unattended-record-body">
                                                <div class="unattended-record-top-tags">
                                                ...
                                                <h4 class="unattended-record-name"><?= h($patientName); ?></h4>
                                                <div class="unattended-record-meta-grid">
                                                    <div class="unattended-meta-cell">
                                                        <strong>Scheduled Date:</strong>
                                                        <span class="date-highlight"><?= h($formattedDate); ?></span>
                                                        <small style="color:#64748b;">(<?= h((string) ($appt['preferred_time'] ?? 'Regular')); ?>)</small>
                                                    </div>
                                                    <div class="unattended-meta-cell">
                                                        <strong>Contact:</strong>
                                                        <span><?= h($contact); ?></span>
                                                    ...
                                                    <div class="unattended-meta-cell">
                                                        ...
                                                        <span><?= h(age_label($appt)); ?> • <?= h((string) ($appt['gender'] ?? '')); ?></span>
                                                    </div>
                                                    <div class="unattended-meta-cell">
                                                        <strong>Health Station:</strong>
                                                        <span><?= h((string) ($appt['station_name'] ?? $station['name'])); ?></span>
                                                    </div>
                                                </div>
                                                <div class="unattended-audit-callout amber">
                                                    <?= staff_icon('alert'); ?>
                            ...
                            <section class="unattended-records-section">
                                <div class="unattended-section-header">
                                    <div class="unattended-section-title-wrap">
                                        ...
                                        <div>
                                            ...
                                            <p>Patients who were confirmed or waiting in queue but station day concluded without consultation completion</p>
                                        </div>
                                    </div>
                                    <span class="unattended-type-tag orange"><?= count($pageUnattendedQueue); ?> Incomplete Visits</span>
                                </div>
                                ...
                                <div class="unattended-cards-stack">
                                    <?php foreach ($pageUnattendedQueue as $qItem): ?>
                                        ...
                                        ?>
                                        <article class="unattended-record-card is-queue">
                                            <div class="unattended-record-body">
                                                <div class="unattended-record-top-tags">
                                                ...
                                                <div class="unattended-record-meta-grid">
                                                    ...
                                                    <div class="unattended-meta-cell">
                                                        ...
                                                        <span class="status-pill status-queue-waiting"><?= h($qStatus); ?></span>
                                                    </div>
                                                    <div class="unattended-meta-cell">
                                                        <strong>Contact:</strong>
                                                        <span><?= h($contact); ?></span>
                                                    ...
                                                    <div class="unattended-meta-cell">
                                                        <strong>Demographics:</strong>
                                                        <span><?= h(age_label($qItem)); ?> • <?= h((string) ($qItem['gender'] ?? '')); ?></span>
                                                    </div>
                                                </div>
                                                <div class="unattended-audit-callout orange">
                                                    <?= staff_icon('clock'); ?>
            ...
            <?php endif; /* end regular dashboard */ ?>
        ...
        <?php elseif ($page === 'patients'): ?>
            <?php if ($view === 'profiles'): ?>
                ...
                <div class="appt-detail-topbar" style="display:flex; justify-content:space-between; align-items:center; margin-bottom:20px; flex-wrap:wrap; gap:12px;">
                    <div class="appt-breadcrumb-trail" style="display:flex; align-items:center; gap:8px; font-size:0.95rem;">
                        ...
                        <span class="appt-breadcrumb-active" style="color:#0f172a; font-weight:700;">Patient Profiles</span>
                    </div>
                ...
                <!-- Page Hero -->
                <section class="page-hero">
                    <h1>All Patient Profiles &amp; Medical History</h1>
                    <p>Complete directory of registered patients and chronological medical histories across all health services.</p>
                </section>

                <!-- Search Bar Section (Transferred here) -->
                <section class="appt-filter-card" style="margin-bottom: 24px;">
                    <form method="get" class="appt-filter-form">
                        ...
                        <div class="appt-search-field" style="flex:1;">
                            <span class="appt-search-icon"><?= staff_icon('search'); ?></span>
                            <input type="text" name="patient_search" value="<?= h($patientSearch); ?>" placeholder="Search all patient profiles by name, ID, phone, or address..." maxlength="50">
                            <?php if ($patientSearch !== ''): ?>
                                <a href="?page=patients&view=profiles" class="appt-search-clear" title="Clear search">
                                    <?= staff_icon('x'); ?>
                                </a>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="appt-filter-dropdowns">
                            ...
                            <?php if ($patientSearch !== ''): ?>
                                <a href="?page=patients&view=profiles" class="appt-filter-reset-btn" title="Reset search">
                                    <?= staff_icon('history'); ?>
                                    <span>Reset</span>
                                </a>
                            <?php endif; ?>
                ...
                <!-- 3 KPI Metric Cards for Patient Profiles -->
                <section class="appt-metrics-grid" style="margin-bottom: 28px;">
                    <article class="appt-metric-card pending">
                        ...
                        <div class="appt-metric-content">
                            <span class="appt-metric-label">Total Patient Profiles</span>
                            <strong class="appt-metric-val"><?= number_format(count($groupedPatientProfiles)); ?></strong>
                        </div>
                    </article>
                    ...
                    <article class="appt-metric-card total">
                        ...
                        <div class="appt-metric-content">
                            <span class="appt-metric-label">Total Completed Consultations</span>
                            <strong class="appt-metric-val"><?= number_format(count($patientStationRecords)); ?></strong>
                        </div>
                    </article>
                    ...
                    <article class="appt-metric-card cancelled">
                        ...
                        <div class="appt-metric-content">
                            <span class="appt-metric-label">Assigned Station</span>
                            <strong class="appt-metric-val" style="font-size:1.1rem;"><?= h($station['name']); ?></strong>
                        </div>
                    </article>
                </section>

                <!-- Section: Completed Patient Profiles & Medical History across all services -->
                    ...
                    <div class="patient-section-header">
                        <div class="section-title-group">
                            ...
                            <div>
                                ...
                                <p>Alphabetically organized patient profiles with complete clinical records across all station services.</p>
                            </div>
                        </div>
                        <span class="patient-section-counter"><?= count($groupedPatientProfiles); ?> <?= count($groupedPatientProfiles) === 1 ? 'patient profile' : 'patient profiles'; ?> (<?= count($patientStationRecords); ?> <?= count($patientStationRecords) === 1 ? 'visit' : 'visits'; ?>)</span>
                    </div>
                    ...
                    <div class="patient-cards-stack">
                        <?php if ($groupedPatientProfiles === []): ?>
                            <div class="panel-card empty-state appt-empty-box">
                                ...
                                <p><?= $patientSearch !== '' ? 'No patient profiles match your search criteria.' : 'No completed patient clinical records found in the system yet.'; ?></p>
                            </div>
                        <?php else: ?>
            ...
            <?php elseif ($programFilter === ''): ?>
                <!-- Main Services Overview: Page Hero with Patient Profiles Action Button -->
                <section class="page-hero" style="display: flex; justify-content: space-between; align-items: center; gap: 20px; flex-wrap: wrap;">
                    <div>
                        <h1>Patient Records &amp; Clinical Details</h1>
                        <p>Select a health service to encode clinical remarks and doctor's notes, or view patient profiles across all services.</p>
                    </div>
                    <div style="flex-shrink: 0;">
                        <a href="?page=patients&view=profiles" class="primary-btn blue-btn" style="padding: 12px 22px; font-size: 0.95rem; font-weight: 700; border-radius: 12px; display: inline-flex; align-items: center; gap: 8px; text-decoration: none; box-shadow: 0 4px 14px rgba(37, 99, 235, 0.28); background: linear-gradient(135deg, #2563eb, #1d4ed8); color: #ffffff; border: none;">
                            <?= staff_icon('patients'); ?>
...
<div class="unattended-modal-backdrop" id="unattendedModal" hidden>
    <div class="unattended-dialog-card">
        <div class="unattended-modal-header">
            ...
            <div style="display:flex;align-items:center;gap:12px;">
                <a href="?page=dashboard&view=unattended" class="unattended-modal-view-all-link" id="unattendedModalViewAllLink" title="View all unattended and unserved records in dashboard">
                    <span>View all</span>
...
(function() {
    ...
    function switchTab(tabName) {
        ...
        const viewAllLnk = document.getElementById('unattendedModalViewAllLink');
        if (viewAllLnk) {
            viewAllLnk.href = '?page=dashboard&view=unattended&type=' + encodeURIComponent(tabName);
        }
    }
...
window.openStaffInfantModal = function(infant) {
    ...
    <div style="background: linear-gradient(135deg, #f0f9ff 0%, #e0f2fe 100%); border: 1.5px solid #bae6fd; border-radius: 16px; padding: 18px 20px; display: flex; align-items: center; gap: 18px; margin-bottom: 22px; flex-wrap: wrap;">
        <div style="width: 72px; height: 72px; border-radius: 50%; background: #ffffff; border: 3px solid #38bdf8; position: relative; overflow: hidden; flex-shrink: 0; color: #0284c7; font-size: 1.6rem; box-shadow: 0 4px 12px rgba(2, 132, 199, 0.2);">
            ${photoHtml}
        </div>
